...
class ShowSeasonEpisodesModel {
    ...
    async addEpisode(showID, seasonID, apiData) {
        ...
        const episode = await this.getSingleByShowSeasonTrakt(showID, seasonID, data.episode_number, data.trakt_id);
        if ("id" in episode) {
            return episode;
        }
        await this._ibdb.insert(data, this._tableName);
        return await this.getSingleByShowSeasonTrakt(showID, seasonID, data.episode_number, data.trakt_id);
    }
    ...
    async getEpisodesForSeason(showID, seasonID) {
        ...
        return await this._ibdb.getAll(where, this._tableName, "episode_number ASC");
    }
