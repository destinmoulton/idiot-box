...
var ShowsModel = /** @class */ (function () {
    ...
    ShowsModel.prototype._prepareData = function (apiData, imageFilename) {
        return {
            title: apiData.title,
            year: apiData.year,
    ...
    ShowsModel.prototype.addShow = function (apiData, imageFilename) {
        return __awaiter(this, void 0, void 0, function () {
            var data, show;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = this._prepareData(apiData, imageFilename);
    ...
    ShowsModel.prototype.getSingle = function (showID) {
        return __awaiter(this, void 0, void 0, function () {
            var where;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ShowsModel.prototype.getSingleBySlug = function (slug) {
        return __awaiter(this, void 0, void 0, function () {
            var where;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ShowsModel.prototype.getSingleByTraktID = function (traktID) {
        return __awaiter(this, void 0, void 0, function () {
            var where;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ShowsModel.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ShowsModel.prototype.deleteSingle = function (showID) {
        return __awaiter(this, void 0, void 0, function () {
            var where;
            return __generator(this, function (_a) {
                switch (_a.label) {
