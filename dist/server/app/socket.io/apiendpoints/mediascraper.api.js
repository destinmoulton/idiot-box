...
var mediascraper = {
    movies: {
        search: {
            ...
            func: function (searchString) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, mediaScraperModel.searchMovies(searchString)];
    ...
    shows: {
        search: {
            ...
            func: function (searchString) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, mediaScraperModel.searchShows(searchString)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            }); }
