...
var filesystem = {
    dir: {
        get: {
            ...
            func: function (basePath, fullPath) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, filesystemModel.getDirList(basePath, fullPath)];
    ...
    trash: {
        execute: {
            ...
            func: function (sourcePath, filenames) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, filesystemModel.trash(sourcePath, filenames)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            }); }
    ...
    rename: {
        multiple: {
            ...
            func: function (sourcePath, destPath, itemsToRename) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, filesystemModel.directMoveMultiple(sourcePath, destPath, itemsToRename)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            }); }
